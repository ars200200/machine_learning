...
def get_optimizers(params, option_optimizer:dict):
    name = option_optimizer['name']

    if name == 'sgd':
        lr = option_optimizer['lr']
        ...
        raise NotImplementedError(f'optimizer {name} is not implemnted')
    return optimizer